                ...
                <div class="well">
					...
					<form:form modelAttribute="categoriaModel" action="${contextPath}/categoria" method="put">
						...
						<div class="form-group">
							<form:input type="hidden" path="idCategoria" name="idCategoria" id="idCategoria" value="${categoriaModel.idCategoria}" />
                       
                        </div>
						
						<div class="form-group">
							<label class="control-label" for="nome">Nome:</label>
							<form:input path="nomeCategoria" type="text" name="nomeCategoria" id="nomeCategoria" value="${categoriaModel.nomeCategoria}" class="form-control" size="50" />
